...
cluster = MongoClient("mongodb+srv://mike:mike2505@cluster0.9naf3.mongodb.net/?retryWrites=true&w=majority")
db = cluster["bakery"]
users = db["users"]
orders = db["orders"]
...
def reply():
    ...
    if bool(user) == False:
        ...
        res.message(f"Your order for {selected} has been received and will be delivered within a hour.")
